...
public class CriticalQuantale extends EffectQuantale<Class<? extends Annotation>> {
  ...
  public Class<? extends Annotation> LUB(
      Class<? extends Annotation> EffectA, Class<? extends Annotation> EffectB) {
    if (EffectA == EffectB) {
      return EffectB;
    }
    if (EffectA == B) {
