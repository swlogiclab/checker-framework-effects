...
public class GenericEffectExtension {
    ...
    public Class<? extends Annotation> checkArrayType(ArrayTypeTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkAssert(AssertTree node) { throw new UnsupportedOperationException(); }
    ...
    public Class<? extends Annotation> checkBreak(BreakTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkCase(CaseTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkCatch(CatchTree node) { throw new UnsupportedOperationException(); }
    ...
    public Class<? extends Annotation> checkContinue(ContinueTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkDoWhileLoop(DoWhileLoopTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkEnhancedForLoop(EnhancedForLoopTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkForLoop(ForLoopTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkIf(IfTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkInstanceOf(InstanceOfTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkIntersectionType(IntersectionTypeTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkLabeledStatement(LabeledStatementTree node) { throw new UnsupportedOperationException(); }
    ...
    public Class<? extends Annotation> checkPrimitiveType(PrimitiveTypeTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkReturn(ReturnTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkSwitch(SwitchTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkSynchronized(SynchronizedTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkThrow(ThrowTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkTry(TryTree node) { throw new UnsupportedOperationException(); }
    ...
    public Class<? extends Annotation> checkUnionType(UnionTypeTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkWhileLoop(WhileLoopTree node) { throw new UnsupportedOperationException(); }
    public Class<? extends Annotation> checkWildcard(WildcardTree node) { throw new UnsupportedOperationException(); }
