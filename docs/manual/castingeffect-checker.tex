...
Overriding a method that already has an effect with another effect will be checked. If the new effect is greater than the overridden effect, an error will be raised.
