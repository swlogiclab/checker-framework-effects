...
\begin{Verbatim}
sudo apt-get update
sudo apt-get install --yes ant dia git hevea junit4 librsvg2-bin make \
 mercurial openjdk-8-jdk texlive-latex-base texlive-latex-recommended \
...
brew install git ant hevea mercurial librsvg unzip make
