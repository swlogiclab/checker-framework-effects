...
\newcommand{\ReleaseVersion}{2.1.14}
\newcommand{\ReleaseInfo}{2.1.14 (3 Aug 2017)}
...
% Include index-checker.tex EXCEPT on buffalo.cs.washington.edu
\ifonbuffalo{\relax}\else{\input{index-checker.tex}}\fi
...
\input{castingeffect-checker.tex}
