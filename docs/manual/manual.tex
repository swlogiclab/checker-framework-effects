...
\newcommand{\ReleaseVersion}{3.12.0}
\newcommand{\ReleaseInfo}{3.12.0 (1 Apr 2021)}
...
%% Checkers
% If you add a new checker, also update the list at the beginning of introduction.tex .
